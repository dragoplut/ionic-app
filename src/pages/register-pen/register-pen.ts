...
export class RegisterPenComponent {
    ...
    this.requestDeviceSettings(this.dpDevice,(resp: any) => {
      ...
      this._pen.writeWithResponse(
        ...
        (resp: any) => {
          ...
          let penUsageListsSize = resp;
          this.logEvent('Success', 'Usage List Size', JSON.stringify(penUsageListsSize, null, 2));
          ...
          this._pen.writeWithResponse(
            ...
            (resp: any) => {
              ...
              syncData.penUsageLists.length = penUsageListsSize;
              ...
              this._pen.writeWithResponse(
                ...
                (resp: any) => {
                  ...
                  let penErrorListsSize = resp;
                  this.logEvent('Success', 'Error List Size', JSON.stringify(penErrorListsSize, null, 2));
                  ...
                  this._pen.writeWithResponse(
                    ...
                    (resp: any) => {
                      ...
                      syncData.penErrorLists.length = penErrorListsSize;
  ...
  public getLastFirmwareVersion(data: any, callback: any) {
    this._firmware.getLastVersionFirmware(this.dpDevice.keyInfo, this.firmwareVersion).subscribe(
      (resp: any) => {
